...
Category.sync().then(function(){
	Item.sync().then(function(){ //currently not forced because I am populating from script
		//User.create({username: 'Admin', role: 'admin', first_name: 'admin', last_name: 'admin', hashedPassword: 'something'});
